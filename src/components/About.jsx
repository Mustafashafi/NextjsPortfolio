                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div variants={itemVariants} className="space-y-6">
                            ...
                            <div className="pt-6 space-y-3">
                                ...
                                <a href="tel:+923363035621" className="flex items-center gap-3 text-slate-700 dark:text-slate-300 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
